...
export default function RegisterForm() {
    ...
    const handleSubmit = (e) => {
        e.preventDefault()
        if (name === '' || email === '' || password === '' || retypedPassword === '' || password !== retypedPassword) {
            setError(true)
        } else {
            setSubmitted(true)
            setError(false)
    ...
    const errorMessage = () => {
        return (
            <div
                ...
                <h1 className='registerError'>The password and confirm password fields do not match.</h1>
            </div>
        )
    }
    return (
        <div className='container registrationForm'>
            <div className="form">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <label className="registerFormLabel listOfCountries">Choose your country*</label>
                    <select id="country" name="country" onChange={handleCountry} className="input"
                        value={country} type="text" required >
                        <option value='' className='countryInputAppearance' selected disabled>-Select Country*-</option>
                    ...
                    <div className="registerTermsAndConditions">
                        ...
                        <Link className="tcAppearance" to="/termsandconditions">Agree with terms and conditions*</Link>
                    </div>
